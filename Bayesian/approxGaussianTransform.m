...
%Generating the samples from the original gaussian distribution
x_s = mvnrnd(mu_x,Sigma_x,N)';

% transforming the samples using the non-linear function provided as an
% argument
y_s = f(x_s); % this is for the matlab assignment 
